...
| 09 | [前端高并发高可用架构](./09-high-concurrency.md) | WebSocket集群、消息推送、流量削峰、分布式状态 |
...
| 15 | [低时延交互控制系统](./15-low-latency-interaction.md) | 游戏引擎、帧/状态同步、远程桌面、预测插值 |
| 16 | [前端分布式数据库](./16-distributed-database.md) | 端侧数据库、多端同步、冲突解决、最终一致性 |
| 17 | [前端构建工程化](./17-build-engineering.md) | TurboPack/Vite/Rspack、Tree-shaking、自定义插件、Bundleless |
| 18 | [前端监控与可观测性](./18-observability.md) | RUM指标体系、异常捕获、性能告警、OpenTelemetry |
| 19 | [微前端架构深入](./19-micro-frontend.md) | 样式隔离、应用间通信、依赖共享、Module Federation |
| 20 | [Web 无障碍 Accessibility A11y](./20-accessibility.md) | WCAG合规、屏幕阅读器、键盘导航、视觉无障碍、自动化检测 |
| 21 | [前端国际化 i18n](./21-i18n.md) | RTL布局、文案管理、Intl API、CJK排版、动态加载 |
| 22 | [CSS 平台新能力体系](./22-css-platform.md) | Cascade Layers、Container Queries、View Transitions、Scroll Animations |
| 23 | [WebAuthn 现代身份认证](./23-webauthn.md) | Passkeys、FIDO2/CTAP2、条件UI、多因子认证、安全模型 |
